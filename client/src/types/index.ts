...
export function findObjByValue (options: ISelectOption[], key: string|number): INamedEntity {
    let obj = options.find(option => {return option.value.toString() === key.toString(); });
